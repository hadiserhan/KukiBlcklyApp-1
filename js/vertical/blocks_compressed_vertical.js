...
Blockly.ScratchBlocks.VerticalExtensions.colourHelper = function (a) {
  ...
  if (!(b && b.primary && b.secondary && b.tertiary && b.quaternary))
...
Blockly.ScratchBlocks.VerticalExtensions.registerAll = function () {
  for (
    var a =
        "control data data_lists sounds motion looks event sensing pen operators more".split(
          " "
        ),
      b = 0;
    b < a.length;
  ...
  init: function () {
    this.jsonInit({
      ...
      args0: [
        {
          type: "field_image",
          src: Blockly.mainWorkspace.options.pathToMedia + "kuki/vertical/new_event_start.svg",
          width: 24,
          height: 24,
          alt: "flag",
        },
...
Blockly.Blocks.event_wait_seconds = {
  init: function () {
    this.jsonInit({
      id: "control_wait_seconds",
      message1: Blockly.Msg.CONTROL_WAIT,
      message0: "%1",
      args1: [{ type: "input_value", name: "DURATION", check: "Number" }],
      args0: [
        {
          type: "field_image",
          src: Blockly.mainWorkspace.options.pathToMedia + "kuki/mixed/control_wait_time.svg",
          width: 24,
          height: 24,
          alt: "flag",
        },
...
Blockly.Blocks.event_wait_until_button_pressed = {
  init: function () {
    this.jsonInit({
      id: "event_wait_until_button_pressed",
      message1: Blockly.Msg.KUKI_WAIT_UNTIL_BUTTON_PRESSED,
      message0: "%1",
      args0: [
        {
          type: "field_image",
...
Blockly.Blocks.event_stopAll = {
    ...
    this.setTooltip("Stop all components from doing something");
    }
};
  ...
  init: function () {
    this.jsonInit({
      ...
      args2: [
        {
          type: "field_image",
          src: Blockly.mainWorkspace.options.pathToMedia + "kuki/mixed/control_loop_number.svg",
          width: 24,
          height: 24,
          alt: "*",
          flip_rtl: !0,
...
Blockly.Blocks.motion_set_speed = {
    init: function() {
        this.appendDummyInput().appendField(new Blockly.FieldImage(
            Blockly.mainWorkspace.options.pathToMedia + "kuki/vertical/motors_move.svg",24,24,"*")).appendField("Set Speed");
        this.appendDummyInput().appendField(new Blockly.FieldDropdown([["SLOW", "0"], ["NORMAL", "1"], ["FAST", "2"]]), "");
        ...
        this.setTooltip("select where and how fast wheels go ");
        //this.setHelpUrl("help/help.html");
    }
};
Blockly.Blocks.motion_move_distance = {
    init: function() {
        this.appendDummyInput().appendField(new Blockly.FieldImage(
            Blockly.mainWorkspace.options.pathToMedia + "kuki/vertical/motors_move.svg",24,24,"*")).appendField("Move");
        this.appendDummyInput().appendField(new Blockly.FieldDropdown([["FORWARD", "-1"], ["BACKWARD", "1"]]), "DIRECTION");
        this.appendValueInput("STEP").setCheck("Number").setAlign(Blockly.ALIGN_CENTRE);
...
Blockly.Blocks.motion_rotate_angle = {
    init: function() {
        this.appendDummyInput().appendField(new Blockly.FieldImage(
          Blockly.mainWorkspace.options.pathToMedia + "kuki/vertical/drive_rotate.svg",24,24,"*"))
          .appendField("Rotate");
        this.appendDummyInput().appendField(new Blockly.FieldDropdown([["LEFT", "-1"], ["RIGHT", "1"]]), "DIRECTION");
        this.appendValueInput("ANGLE").setCheck("Number").setAlign(Blockly.ALIGN_CENTRE);
...
Blockly.Blocks.motion_rotate_angle_by_wheel = {
    init: function() {
        this.appendDummyInput().appendField(new Blockly.FieldImage(
          Blockly.mainWorkspace.options.pathToMedia + "kuki/vertical/one_motor.svg",24,24,"*")).appendField("Motor");
        this.appendDummyInput().appendField(new Blockly.FieldDropdown([["LEFT", "-1"], ["RIGHT", "1"]]), "DIRECTION");
...
Blockly.Blocks.motion_move_distance_with_speed = {
    init: function() {
        this.appendDummyInput().appendField(new Blockly.FieldImage(
            Blockly.mainWorkspace.options.pathToMedia + "kuki/vertical/motors_move.svg",24,24,"*")).appendField("Move");
        this.appendDummyInput().appendField(new Blockly.FieldDropdown([["FORWARD", "-1"], ["BACKWARD", "1"]]), "DIRECTION");
        this.appendValueInput("STEP").setCheck("Number").setAlign(Blockly.ALIGN_CENTRE);
        this.appendDummyInput().appendField("cm");
        this.appendDummyInput().appendField(new Blockly.FieldDropdown([["SLOW", "2"], ["NORMAL", "1"], ["FAST", "3"]]), "SPEED");
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
       this.setColour(Blockly.Colours.motion.primary,
        Blockly.Colours.motion.secondary,
...
Blockly.Blocks.motion_rotate_angle_with_speed = {
    init: function() {
        this.appendDummyInput().appendField(new Blockly.FieldImage(
          Blockly.mainWorkspace.options.pathToMedia + "kuki/vertical/drive_rotate.svg",24,24,"*"))
          .appendField("Rotate");
...
Blockly.Blocks.motion_rotate_angle_by_wheel_with_speed = {
    init: function() {
        this.appendDummyInput().appendField(new Blockly.FieldImage(
          Blockly.mainWorkspace.options.pathToMedia + "kuki/vertical/one_motor.svg",24,24,"*")).appendField("Motor");
        this.appendDummyInput().appendField(new Blockly.FieldDropdown([["LEFT", "-1"], ["RIGHT", "1"]]), "DIRECTION");
...
Blockly.Blocks.kuki_light = {
      init: function() {
        this.appendDummyInput().appendField(new Blockly.FieldImage(
          Blockly.mainWorkspace.options.pathToMedia + "kuki/led-light-off.svg",24,24,"*")).appendField("Built In LED");
        this.appendDummyInput().appendField(new Blockly.FieldDropdown([["OFF", "-1"], ["ON", "-1"], ["TOGGLE", "1"]]), "DIRECTION");
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
...
Blockly.Blocks.kuki_RGB_light_off = {
    init: function() {
         this.appendDummyInput().appendField(new Blockly.FieldImage(
          Blockly.mainWorkspace.options.pathToMedia + "kuki/rgb-LED-off.png",24,24,"*")).appendField("RGB OFF");
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setColour(
        ...
        this.setTooltip("turn off all lights");
        //this.setHelpUrl("help/help.html");
    }
};
Blockly.Blocks.kuki_RGB_light_color = {
      init: function() {
        this.appendDummyInput().appendField(new Blockly.FieldImage(
          Blockly.mainWorkspace.options.pathToMedia + "kuki/rgb-LED-on.png",24,24,"*")).appendField("RGB Color");
       this.appendValueInput("ALL_COLOUR").setAlign(Blockly.ALIGN_CENTRE);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setColour(
          Blockly.Colours.looks.primary,
        ...
        this.setTooltip("fill all lights with one color");
    }
};
Blockly.Blocks.kuki_RGB_light_R_G_B = {
    init: function() {
        this.appendDummyInput().appendField(new Blockly.FieldImage(
           Blockly.mainWorkspace.options.pathToMedia + "kuki/rgb-LED-on.png",24,24,"*")).appendField("RGB");
        this.appendValueInput("RED").appendField("🔴 Red").setCheck("Number").setAlign(Blockly.ALIGN_CENTRE);
        this.appendValueInput("GREEN").appendField("🟢 Green").setCheck("Number").setAlign(Blockly.ALIGN_CENTRE);
        this.appendValueInput("BLUE").appendField("🔵 Blue").setCheck("Number").setAlign(Blockly.ALIGN_CENTRE);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
...
Blockly.Blocks.kuki_RGB_light_Random = {
    init: function() {
         this.appendDummyInput().appendField(new Blockly.FieldImage(
          Blockly.mainWorkspace.options.pathToMedia + "kuki/rgb-LED-random.svg",24,24,"*")).appendField("RGB Random");
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setColour(
          Blockly.Colours.looks.primary,
...
Blockly.Blocks.kuki_matrix_btimap = {
    init: function() {
         this.appendDummyInput().appendField(new Blockly.FieldImage(
          Blockly.mainWorkspace.options.pathToMedia + "kuki/dotMatrix.png",24,24,"*")).appendField("Matrix");
        this.appendDummyInput().appendField(new Blockly.FieldVerticalSeparator());
         this.appendValueInput("DisplayValue").setAlign(Blockly.ALIGN_CENTRE);
          this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setColour(
          Blockly.Colours.display.primary,
          Blockly.Colours.display.secondary,
          Blockly.Colours.display.tertiary
        );
        this.setTooltip("turn off all lights");
        //this.setHelpUrl("help/help.html");
    }
...
//! ******************************************************************* */
//* START SOUNDS
Blockly.Blocks.kuki_beep = {
    init: function() {
         this.appendDummyInput().appendField(new Blockly.FieldImage(
          Blockly.mainWorkspace.options.pathToMedia + "kuki/kuki_sound_on.svg",24,24,"*")).appendField("Beep");
          this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setColour(
...
Blockly.Blocks.kuki_sound_animals = {
    init: function() {
         this.appendDummyInput().appendField(new Blockly.FieldImage(
          Blockly.mainWorkspace.options.pathToMedia + "kuki/kuki_sounds_animal_1.svg",24,24,"*")).appendField("Animal Sounds");
...
Blockly.Blocks.kuki_sound_effects = {
    init: function() {
         this.appendDummyInput().appendField(new Blockly.FieldImage(
          Blockly.mainWorkspace.options.pathToMedia + "kuki/kuki_sound_effects_1.svg",24,24,"*")).appendField("Effects Sounds");
          this.appendDummyInput().appendField(new Blockly.FieldDropdown([
              ['🐱 Cat','\'0\''],
              ['🐦 Seagull','\'1\''],
              ['🐦 Bird','\'2\''],
...
Blockly.Blocks.kuki_pen = {
    init: function() {
        this.appendDummyInput().appendField(new Blockly.FieldImage(
          Blockly.mainWorkspace.options.pathToMedia + "kuki/vertical/pen.svg",24,24,"*")).appendField("Pen");
        this.appendDummyInput().appendField(new Blockly.FieldDropdown([
            ["UP", "1"],
            ["DOWN", "2"],
            ["TOGGLE", "3"]
...
Blockly.Blocks.procedures_defnoreturn = {
   init: function() {
    ...
    if ((this.workspace.options.comments ||
     ...
     this.setColour(
          Blockly.Colours.procedures.primary,
    ...
    var container =  goog.dom.createElement('mutation');
    if (opt_paramIds) {
      container.setAttribute('name', this.getFieldValue('NAME'));
    }
    for (var i = 0; i < this.argumentVarModels_.length; i++) {
      var parameter =  goog.dom.createElement('arg');
  ...
  decompose: function(workspace) {
    var containerBlockNode = goog.dom.createElement('block');
    containerBlockNode.setAttribute('type', 'procedures_mutatorcontainer');
    var statementNode = goog.dom.createElement('statement');
    statementNode.setAttribute('name', 'STACK');
    containerBlockNode.appendChild(statementNode);

    var node = statementNode;
    for (var i = 0; i < this.arguments_.length; i++) {
      var argBlockNode = goog.dom.createElement('block');
      argBlockNode.setAttribute('type', 'procedures_mutatorarg');
      var fieldNode = goog.dom.createElement('field');
      fieldNode.setAttribute('name', 'NAME');
      var argumentName = goog.dom.createTextNode(this.arguments_[i]);
      fieldNode.appendChild(argumentName);
      argBlockNode.appendChild(fieldNode);
      var nextNode = goog.dom.createElement('next');
  ...
  customContextMenu: function(options) {
    ...
    var xmlMutation = goog.dom.createElement('mutation');
    xmlMutation.setAttribute('name', name);
    for (var i = 0; i < this.arguments_.length; i++) {
      var xmlArg = goog.dom.createElement('arg');
      xmlArg.setAttribute('name', this.arguments_[i]);
      xmlMutation.appendChild(xmlArg);
    }
    var xmlBlock = goog.dom.createElement('block');
    ...
    if (!this.isCollapsed()) {
      for (var i = 0; i < this.argumentVarModels_.length; i++) {
        ...
        var argXmlBlock = goog.dom.createElement('block');
  ...
  onchange: function(event) {
    ...
    if (event.type == Blockly.Events.BLOCK_CREATE &&
      ...
      if (!def) {
        ...
        var xml = goog.dom.createElement('xml');
        var block = goog.dom.createElement('block');
        ...
        var field = goog.dom.createElement('field');
        field.setAttribute('name', 'NAME');
        field.appendChild(goog.dom.createTextNode(
...
Blockly.Blocks.matrix_input = {
    init: function() {
        this.jsonInit({
            ...
            "output": "String",
            "outputShape": Blockly.OUTPUT_SHAPE_ROUND,
             colour:Blockly.Colours.display.primary,
            colourSecondary: Blockly.Colours.display.secondary,
            colourTertiary: Blockly.Colours.display.tertiary,
        });
    }
};
...
Blockly.ScratchBlocks.ProcedureUtils.checkOldTypeMatches_ = function (a, b) {
  return a
    ? (("n" == b || "s" == b) && "argument_reporter_string_number" == a.type) ||
      ("b" == b && "argument_reporter_boolean" == a.type)
      ? !0
      : !1
    : !1;
};
...
Blockly.ScratchBlocks.ProcedureUtils.updateDeclarationProcCode_ = function () {
  ...
  for (var a = 0; a < this.inputList.length; a++) {
    ...
    if (b.type == Blockly.DUMMY_INPUT)
      ...
      this.procCode_ =
        "argument_editor_boolean" == c.type
          ? this.procCode_ + "%b"
          : this.procCode_ + "%s";
    } else
      throw Error(
...
Blockly.ScratchBlocks.ProcedureUtils.updateArgumentReporterNames_ = function (
  ...
  if (e) {
    for (var f = e.getDescendants(!1), g = 0; g < f.length; g++)
      (e = f[g]),
        ("argument_reporter_string_number" !== e.type &&
          "argument_reporter_boolean" !== e.type) ||
          e.isShadow() ||
          d.push(e);
